        ...
        >
          <form className="space-y-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-[#149496] text-white px-8 py-4 rounded-2xl font-['Poppins'] uppercase tracking-wider shadow-lg hover:bg-[#1e7872] transition-colors"
            >
              Send Message
            </motion.button>
          </form>
        ...
        >
          ...
          <div className="pt-8 border-t border-white/20">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <motion.a
                href="mailto:resources@villagevalues.com"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              ...
              >
                <EmailResourceIcon />
                resources@villagevalues.com
              </motion.a>
              <motion.a
                href="#contact-form"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-[#c49a3a] text-white px-6 py-3 rounded-full font-['Poppins'] hover:bg-[#b38a2a] transition-colors"
              >
                Partner With Us
              </motion.a>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-4 lg:pt-32">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="block w-full bg-[#149496] text-white px-6 py-4 rounded-2xl font-['Poppins'] text-center uppercase tracking-wider shadow-lg hover:bg-[#1e7872] transition-colors"
              >
                View Open Roles
              </motion.a>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="block w-full bg-white border-2 border-[#c49a3a] text-[#232e43] px-6 py-4 rounded-2xl font-['Poppins'] text-center uppercase tracking-wider shadow-lg hover:bg-[#f5edda] transition-colors"
              >
