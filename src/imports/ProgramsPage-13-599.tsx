import svgPaths from "./svg-js3y2l02vb";
...
function Container4() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[500px] items-start left-[624px] overflow-clip rounded-[24px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] top-0 w-[496px]" data-name="Container">
      <ImageWithFallback />
    </div>
  );
}
...
function InfantProgram10() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[500px] items-start left-0 overflow-clip rounded-[24px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] top-0 w-[488px]" data-name="InfantProgram">
      <ImageWithFallback1 />
    </div>
  );
}
...
function InfantProgram11() {
  return (
    <div className="absolute bg-[#e5795b] content-stretch flex flex-col h-[76px] items-start left-[294px] pb-0 pt-[24px] px-[24px] rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[-23.46px] w-[238px]" data-name="InfantProgram">
      <Paragraph />
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[24px] h-[331.198px] items-start left-0 pb-0 pt-[32px] px-[32px] rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[302.25px] w-[488px]" data-name="Container">
      <ToddlerProgram3 />
      <ToddlerProgram10 />
    </div>
  );
...
function Container22() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[600px] items-start left-[552px] overflow-clip rounded-[24px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] top-[56.72px] w-[488px]" data-name="Container">
      <ImageWithFallback2 />
    </div>
  );
}
...
function PreschoolProgram4() {
  return (
    <div className="h-[56px] relative shrink-0 w-[243.458px]" data-name="PreschoolProgram">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] h-[56px] items-start relative w-[243.458px]">
        <Heading2 />
        <Paragraph1 />
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f5edda] h-[104px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
      <div className="size-full">
        <div className="content-stretch flex gap-[16px] h-[104px] items-start pb-0 pl-[24px] pr-0 pt-[24px] relative w-full">
          <PreschoolProgram3 />
          <PreschoolProgram4 />
        </div>
      </div>
...
function PreschoolProgram6() {
  return (
    <div className="h-[56px] relative shrink-0 w-[273.073px]" data-name="PreschoolProgram">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] h-[56px] items-start relative w-[273.073px]">
        <Heading3 />
        <Paragraph2 />
      </div>
    </div>
...
function PreschoolProgram8() {
  return (
    <div className="h-[56px] relative shrink-0 w-[272.229px]" data-name="PreschoolProgram">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] h-[56px] items-start relative w-[272.229px]">
        <Heading4 />
        <Paragraph3 />
      </div>
    </div>
...
function PreschoolProgram10() {
  return (
    <div className="h-[56px] relative shrink-0 w-[283.99px]" data-name="PreschoolProgram">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] h-[56px] items-start relative w-[283.99px]">
        <Heading5 />
        <Paragraph4 />
      </div>
    </div>
...
function PreschoolProgram11() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] content-stretch flex flex-col h-[600px] items-start left-0 overflow-clip rounded-[24px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] top-0 w-[488px]" data-name="PreschoolProgram">
      <ImageWithFallback3 />
    </div>
  );
}
...
function PreschoolProgram12() {
  return (
    <div className="absolute bg-[#c49a3a] content-stretch flex flex-col h-[76px] items-start left-[-24px] pb-0 pt-[24px] px-[24px] rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[548px] w-[227.052px]" data-name="PreschoolProgram">
      <Paragraph5 />
    </div>
  );
}
...
function Container35() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[64px] h-[927.198px] items-start left-[487px] px-[80px] py-0 top-[96px] w-[1200px]" data-name="Container">
      <Container26 />
      <Container34 />
    </div>
  );
...
function Container46() {
  return (
    <div className="absolute bg-[#f5edda] content-stretch flex flex-col gap-[16px] h-[255.198px] items-start left-0 pb-[2px] pt-[34px] px-[34px] rounded-[16px] top-[524px] w-[896px]" data-name="Container">
...
function Container54() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[387.333px] items-start overflow-clip relative rounded-[24px] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Container">
      <ComparePrograms22 />
    </div>
  );
}
...
function Container56() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[64px] h-[703.333px] items-start left-[487px] px-[80px] py-0 top-[96px] w-[1200px]" data-name="Container">
      <Container50 />
      <Container54 />
      <Container55 />
    </div>
...
function Container69() {
  return (
    <div className="bg-white h-[692px] relative rounded-[24px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-full" data-name="Container">
      <div className="size-full">
        <div className="content-stretch flex flex-col h-[692px] items-start pb-0 pt-[48px] px-[48px] relative w-full">
          <Form />
        </div>
      </div>
    </div>
...
function Footer() {
  return (
    <div className="absolute bg-[#232e43] content-stretch flex flex-col gap-[48px] h-[412.667px] items-start left-0 pb-0 pt-[64px] px-[567px] top-[7238.76px] w-[2174px]" data-name="Footer">
      <Container78 />
      <Container80 />
    </div>
  );
...
function ProgramsBottomDock() {
  return (
    <div className="absolute bg-[rgba(196,154,58,0.95)] content-stretch flex flex-col h-[61.333px] items-start left-[575px] p-[0.667px] rounded-[32px] top-[7566px] w-[1024px]" data-name="ProgramsBottomDock">
